        ...
        <footer className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center items-center text-yellow-500 sm:justify-start">
                            <Image src='/images/Chef.png' width={40} height={40} />
                            <h1 className='ms-3 text-lg font-medium text-black'>FoodFiesta</h1>
                        </div>
                        ...
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-yellow-500 transition hover:text-yellow-500/75"
                                >
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        <p className="text-sm text-gray-500">
                            ...
                            <a
                                className="inline-block text-yellow-500 underline transition hover:text-yellow-500/75"
                                href="#"
                            >
                                Terms & Conditions
                            </a>
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 foodfiesta24@gmail.com</p>
                    </div>
                </div>
            </div>
        </footer>
